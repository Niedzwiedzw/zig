...
const libc_top_half_src_files = [_][]const u8{
    ...
    "wasix/libc-top-half/musl/src/locale/strtod_l.c",
    ...
    "wasix/libc-top-half/musl/src/stdlib/qsort_nr.c",
...
const crt1_command_src_file = "wasix/libc-bottom-half/crt/crt1-command.c";
const crt1_reactor_src_file = "wasix/libc-bottom-half/crt/crt1-reactor.c";

const emulated_process_clocks_src_files = &[_][]const u8{
    "wasix/libc-bottom-half/clocks/clock.c",
    "wasix/libc-bottom-half/clocks/getrusage.c",
    "wasix/libc-bottom-half/clocks/times.c",
};

const emulated_getpid_src_files = &[_][]const u8{
    "wasix/libc-bottom-half/getpid/getpid.c",
};

const emulated_mman_src_files = &[_][]const u8{
    "wasix/libc-bottom-half/mman/mman.c",
};

const emulated_signal_bottom_half_src_files = &[_][]const u8{
    "wasix/libc-bottom-half/signal/signal.c",
};

const emulated_signal_top_half_src_files = &[_][]const u8{
    "wasix/libc-top-half/musl/src/signal/psignal.c",
    "wasix/libc-top-half/musl/src/string/strsignal.c",
};
